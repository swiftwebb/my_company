...
const ContactUs = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "c26ff1f0-10a7-444f-9329-d609b55cfb50");
    ...
    onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
        ...
        <div>
            ...
            dark:border-gray-600'>
              ...
              <input name='emial' type="email" placeholder='Enter your email' className=' w-full 
              p-3 text-sm outline-none' required />
        ...
        text-white text-sm px-10 py-3 rounded-full cursor-pointer hover:scale-103 transtion-all'>
